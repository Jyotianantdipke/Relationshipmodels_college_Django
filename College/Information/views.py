...
def stu_add(request):
    ...
    template_name = 'Information/studentadd.html'
    context = {'form': form}
...
def dept_add(request):
    ...
    template_name = 'Information/deptadd.html'
    context = {'form': form}
    return render(request, template_name, context)
...
def lect_add(request):
    ...
    template_name = 'Information/lectadd.html'
    context = {'form': form}
    return render(request, template_name, context)
...
def show_stud(request):
    ...
    template_name = 'Information/showstudent.html'
...
def show_lect(request):
    ...
    template_name = 'Information/showlect.html'
    context = {'records': records}
    return render(request, template_name, context)
...
def show_dept(request):
    records = Department.objects.all()
    template_name = 'Information/showdept.html'
    context = {'records': records}
    return render(request, template_name, context)
...
def search(request):
    ...
    if request.method == 'POST':
        ...
        return render(request, 'Information/showresult.html', context)
    template_name = 'Information/search.html'
    context = {}
    return render(request, template_name, context)
...
def search_dept_stu(request, id):
    ...
    print(record)
    template_name = 'Information/showdeptstudent.html'
...
def search_dept_lect(request, id):
    ...
    print(record)
    template_name = 'Information/showdeptlect.html'
    context = {'record': record}
    return render(request, template_name, context)
